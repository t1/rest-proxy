...
public class WebJarsResource {
    // FIXME this prevents arbitrary webjars, but allows for the generic proxy
    private static final String ALLOWED = "css|doc|fonts|html|img|js|scripts|styles";
    private static final List<String> ALLOWED_STATIC_FOLDERS = asList(ALLOWED.split("\\|"));
    ...
    @GET
    @Path("/{artifact:" + ALLOWED + "}/{filePath:.*}")
